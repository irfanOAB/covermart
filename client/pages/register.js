            ...
            <div className="mt-1">
              <input
                ...
                className={`appearance-none block w-full px-3 py-2 border ${
                  formErrors.name ? 'border-red-500' : 'border-dark-100'
          ...
          <div>
            ...
            <div className="mt-1">
              <input
                ...
                onChange={handleChange}
                className={`appearance-none block w-full px-3 py-2 border ${
                  formErrors.phone ? 'border-red-500' : 'border-dark-100'
                } rounded-md shadow-sm placeholder-gray-500 bg-dark-300 text-white focus:outline-none focus:ring-accent-400 focus:border-accent-400 sm:text-sm`}
          ...
          <div>
            ...
            <div className="mt-1">
              <input
                ...
                onChange={handleChange}
                className={`appearance-none block w-full px-3 py-2 border ${
                  formErrors.confirmPassword ? 'border-red-500' : 'border-dark-100'
                } rounded-md shadow-sm placeholder-gray-500 bg-dark-300 text-white focus:outline-none focus:ring-accent-400 focus:border-accent-400 sm:text-sm`}
              />
